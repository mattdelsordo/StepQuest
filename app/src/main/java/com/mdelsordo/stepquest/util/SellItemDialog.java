...
public class SellItemDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity(), R.style.DialogTheme).setTitle("Sell " + name + "?").setMessage("Are you sure you want to sell one (1) "+ name + " for " + price + " gold?").setNegativeButton(getString(R.string.no_thanks), null)
