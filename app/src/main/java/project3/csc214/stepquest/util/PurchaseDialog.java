...
public class PurchaseDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity()).setView(view).setNegativeButton(R.string.no_thanks, null).setPositiveButton(R.string.yes_please, new DialogInterface.OnClickListener() {
            @Override
